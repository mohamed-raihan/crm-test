...
const PaymentDetailsForm = ({
  ...
  const calculateNextDueDate = () => {
    if (formData.policy_id && formData.transaction_date) {
      const selectedPolicy = userpolicies.find(
        (policy) => policy.id == formData.policy_id
      );
      ...
      if (selectedPolicy?.policy_term_duration) {
        ...
        if (match) {
          ...
          let newDueDate = dayjs(formData.transaction_date);
  ...
  }, [formData.transaction_date, formData.policy_id, userpolicies]);
