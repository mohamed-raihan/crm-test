...
const PolicyDetailsForm = ({
  ...
  const fetchPlans = async () => {
    try {
      ...
      const matchedPlans = response.data.filter(
        (plan) => plan.policy == formData.policy
      );
  ...
  const validateForm = () => {
    ...
    if (!formData.premium_amount1) {
      errors.premium_amount1 = "Premium amount is required";
      isValid = false;
    } else if (
      isNaN(formData.premium_amount1) ||
      formData.premium_amount1 <= 0
    ) {
      errors.premium_amount1 = "Premium amount must be a positive number";
      isValid = false;
    }

    // Validate coverage amount
    if (!formData.coverage_amount1) {
      errors.coverage_amount1 = "Coverage amount is required";
      isValid = false;
    } else if (
      isNaN(formData.coverage_amount1) ||
      formData.coverage_amount1 <= 0
    ) {
      errors.coverage_amount1 = "Coverage amount must be a positive number";
      isValid = false;
    }
          ...
          <Col md={6}>
            <FormGroup>
              ...
              <Input
                ...
                className={validationErrors.policy ? "is-invalid" : ""}
                required
              >
          ...
          <Col md={6}>
            <FormGroup>
              ...
              <Input
                ...
                onChange={handleInputChange}
                className={validationErrors.start_date ? "is-invalid" : ""}
                required
              />
        ...
        {!isHospicash ? (
          <div>
            <Row>
              <Col md={6}>
                <FormGroup>
                  <Label for="coverage_amount1">Coverage amount</Label>
                  <Input
                    className="bg-light"
                    id="coverage_amount1"
                    name="coverage_amount1"
                    placeholder="Enter coverage amount"
                    type="text"
                    value={formData.coverage_amount1}
                    onChange={handleInputChange}
                    invalid=""
                  />
            ...
            <Row>
              <Col md={6}>
                <FormGroup>
                  <Label for="premium_amount1">Total premium amount</Label>
                  <Input
                    className="bg-light"
                    id="premium_amount1"
                    name="premium_amount1"
                    placeholder="Total premium amount"
                    value={formData.premium_amount1}
                    onChange={handleInputChange}
                    invalid=""
                  />
            ...
            <Row>
              ...
              <Col md={6}>
                <FormGroup>
                  <Label for="total_premium_amount1">Premium Amount</Label>
                  <Input
                    className="bg-light"
