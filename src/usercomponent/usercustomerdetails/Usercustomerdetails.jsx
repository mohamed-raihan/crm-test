...
import { CustomerTableColumn, CustomeruserTableColumn } from "../../component/Common/TableDatas.jsx";
import DataTable from "react-data-table-component";
import { Button, Input, Modal } from "reactstrap";
import NewUserModal from "./Newcustomerdetails.jsx";
// import ViewUserModal from "./Viewmanagercustomer.jsx";
import Editcustomermodal from "./EditUsercustomerdetails.jsx";
...
console.log(usernominee);
  ...
  const handledelete = async (id) => {
    try {
      const response = await allaxios.delete(API_URL.CUSTOMER.DELETE_CUSTOMER(id), {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("authToken")}`,
        },
      });
  ...
  return (
    <div className="table-wrapper">
      ...
      <DataTable
        ...
        data={filteredData}
        columns={CustomeruserTableColumn(
          handleViewUser,
          handleEditUser,
          handledelete,
