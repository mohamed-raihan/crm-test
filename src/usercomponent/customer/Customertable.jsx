...
import NewUserModal from "./Newusercustomer.jsx";
import ViewUserModal from "./Viewusercustomer.jsx";
import Editcustomermodal from "./Editusercustomer.jsx";
...
const Customertable = () => {
  ...
  const fetchCustomers = async () => {
    ...
    try {
      ...
      //   (customer) => customer.created_by === userData.login_id
      // );
