...
import NewPoliciesModal from "./Newpolicies";
import Viewpoliciesmodal from "./Viewpolicies";
import Editpoliciesmodal from "./Editpolicies";
    ...
    <div className="table-wrapper">
      <div className="d-flex flex-wrap justify-content-between p-3 border mb-2 shadow">
        ...
        <div className="d-flex">
          ...
          />
          <button onClick={toggle} className="bg-primary text-white btn w-50">
            + Add new
          </button>
        </div>
      </div>
      ...
      <Modal
        ...
        scrollable={true}
      >
        <NewPoliciesModal toggle={toggle} />
      </Modal>
